...
test('urgent actions precede lower priority actions and answers are escaped', () => {
  ...
  const findings = html.slice(html.indexOf('class="rr-finding-list"'));
  assert.ok(findings.indexOf('data-edit-section="2"') < findings.indexOf('data-edit-section="1"'));
...
test('strong results show no false urgency or placeholder finding', () => {
  ...
  assert.doesNotMatch(html, /class="rr-finding"/);
});
