-- The linked database is running the pre-membership schema. Use the caller's
-- existing WISP permissions/RLS instead of a SECURITY DEFINER membership lookup.
